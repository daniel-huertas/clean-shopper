...
- Name the dimension (e.g. "Dimension 6 — Unresolved References")
- Quote the exact original text that was changed (e.g. original: "update it to show...")
- Explain the fix and why it improves the prompt
