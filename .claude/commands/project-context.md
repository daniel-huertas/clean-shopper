...
description: Generates a structured project context document from any project input. Use when given a PRD, brief, bullet points, screenshots, or rough notes about a project. Produces nine sections covering problem, user, pain points, solution, success metrics, design constraints, user research insights, open questions, and gaps. Suitable as the starting context document for any new design or build project.
---
...
[Any direct observations, quotes, interview findings, survey results, usability notes, or behavioral data present in the input. Extract verbatim quotes where available. Note the source and context of each insight (e.g. interview, survey, support ticket, sales call). If no user research is present in the input, write "Not defined in source material" and add it to the Gaps section.]
